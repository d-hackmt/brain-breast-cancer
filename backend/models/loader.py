...
loader.py
─────────
Model loading utilities for OncoScan AI.
...
def load_model() -> tf.keras.Model:
    """
    Download and load the pre-trained OncoScan model from HuggingFace Hub.

    The download is deferred to call-time (not import-time) to avoid
    async-loop issues with httpx/uvicorn during module import scans.
